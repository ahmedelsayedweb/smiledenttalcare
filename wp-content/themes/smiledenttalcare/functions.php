...
function ahmed_add_scripts() {
	...
	wp_enqueue_script('custom', get_template_directory_uri() . '/assets/js/jquery-2.1.4.min.js', array() , false, true);
	wp_enqueue_script('bootstrap', get_template_directory_uri() . '/assets/js/bootstrap.min.js', array() , false, true);
	wp_enqueue_script('magnific', get_template_directory_uri() . '/assets/js/jquery.validate.min.js', array() , false, true);
	wp_enqueue_script('slick', get_template_directory_uri() . '/assets/js/swiper.min.js', array() , false, true);
	wp_enqueue_script('flowplayer', get_template_directory_uri() . '/assets/js/swiper-init.js', array() , false, true);
	wp_enqueue_script('carousel', get_template_directory_uri() . '/assets/js/owl.carousel.js', array() , false, true);
	wp_enqueue_script('slider', get_template_directory_uri() . '/assets/js/slider-init.js', array() , false, true);
